...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    if (this.management) {
      this.addComponent = Site.Console.components.addNav2Link(this, 'Add User', 5, function () {
